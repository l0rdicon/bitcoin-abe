...
<header class="navbar navbar-inverse" role="navigation">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="logo navbar-brand" href="%(dotdot)s%(HOMEPAGE)s">Clam Block Explorer</a> </div>
...
class Abe:
    ...
    def _show_block(abe, page, dotdotblock, chain, **kwargs):
        ...
        body += ['<tr><td>','Proof of Stake' if is_stake_block else 'Proof of Work','</td><td>' if b['is_proof_of_stake'] else 'Proof of Work',': ',format_satoshis(b['generated'], chain), ' coins generated</td></tr>']
        ...
        if b['chain_satoshi_seconds'] is not None:
            if b['chain_satoshi_seconds'] == 0:
                body += ['<tr><td>Cumulative Coin-days Destroyed</td><td>',0.0]
            else:
    ...
    def show_tx(abe, page, tx):
        ...
        body += ['<tr><td>clamSpeech</td><td>', tx['comment'], '</td></tr>']
    ...
    def short_link(abe, page, link):
        ...
        return ['<p class="shortlink"><a href="',
